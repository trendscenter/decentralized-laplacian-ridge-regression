...
//         console.log('opts.previousData is', opts.previousData);
       ...
       console.log('opts.remoteResult.data.statisticStep is', opts.remoteResult.data.statisticStep);
        ...
        if ((opts.remoteResult.data.endOfIteration == true) && (opts.remoteResult.data.statisticStep == 0)){
        ...
        else if ((opts.remoteResult.data.endOfIteration == true) && (opts.remoteResult.data.statisticStep == 1)){   
           // step 1 receive the globalMeanY and currW, then calculate sseLocal, sstLocal and varXLocal
  ...
  remote: {
    ...
    else if ((opts.userResults[0].data.endOfIteration == true) && (opts.userResults[0].data.statisticStep == 1)) {
